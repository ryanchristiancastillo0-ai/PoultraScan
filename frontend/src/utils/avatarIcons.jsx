...
function FarmerIcon({ className = '' }) {
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Shirt */}
      <path d="M10 60c0-10 8-16 22-16s22 6 22 16z" fill="#2E7D32" />
      <path d="M24 46c2 3 5 4 8 4s6-1 8-4l-2 6c-2 2-4 3-6 3s-4-1-6-3z" fill="#E8F5E9" />
      {/* Neck */}
      ...
      <path d="M20 17c0-6 5-10 12-10s12 4 12 10c-3-2-8-3-12-3s-9 1-12 3z" fill="#F9A825" />
      <path d="M22 16.5c2-1 6-1.5 10-1.5s8 .5 10 1.5" stroke="#C4922F" strokeWidth="1" strokeLinecap="round" />
      {/* Eyes */}
      <circle cx="27.5" cy="28" r="1.4" fill="#1B1D1B" />
      <circle cx="36.5" cy="28" r="1.4" fill="#1B1D1B" />
    </svg>
  );
}
...
function VetIcon({ className = '' }) {
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Coat */}
      <path d="M10 60c0-10 8-16 22-16s22 6 22 16z" fill="#F8FAF7" />
      <path d="M24 46c2 3 5 4 8 4s6-1 8-4v14H24z" fill="#F8FAF7" />
      <path d="M24 46l3 4-3 4-2-6zM40 46l-3 4 3 4 2-6z" fill="#E5E7EB" />
      {/* Stethoscope */}
      <path d="M22 48c0 6 4 9 10 9s10-3 10-9" stroke="#2E7D32" strokeWidth="2" fill="none" strokeLinecap="round" />
      <circle cx="32" cy="57" r="2.4" fill="#2E7D32" />
      {/* Neck */}
...
function AgronomistIcon({ className = '' }) {
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Glasses */}
      <circle cx="27.5" cy="28" r="3.2" fill="none" stroke="#1B1D1B" strokeWidth="1.2" />
      <circle cx="36.5" cy="28" r="3.2" fill="none" stroke="#1B1D1B" strokeWidth="1.2" />
      <path d="M30.7 28h1.6" stroke="#1B1D1B" strokeWidth="1.2" />
      <circle cx="27.5" cy="28" r="1.1" fill="#1B1D1B" />
      <circle cx="36.5" cy="28" r="1.1" fill="#1B1D1B" />
    </svg>
  );
}
...
function RancherIcon({ className = '' }) {
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Eyes */}
      <circle cx="27.5" cy="27" r="1.4" fill="#1B1D1B" />
      <circle cx="36.5" cy="27" r="1.4" fill="#1B1D1B" />
    </svg>
  );
}
...
function FieldWorkerIcon({ className = '' }) {
  return (
    <svg viewBox="0 0 64 64" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Shirt */}
      <path d="M10 60c0-10 8-16 22-16s22 6 22 16z" fill="#276C2A" />
      <path d="M24 46c2 3 5 4 8 4s6-1 8-4l-2 6c-2 2-4 3-6 3s-4-1-6-3z" fill="#E8F5E9" />
      {/* Neck */}
      ...
      <path d="M45 22c2 1 4 4 4 8-2-1-4-3-5-6z" fill="#F9A825" />
      {/* Eyes */}
      <circle cx="27.5" cy="29" r="1.4" fill="#1B1D1B" />
      <circle cx="36.5" cy="29" r="1.4" fill="#1B1D1B" />
    </svg>
  );
}
