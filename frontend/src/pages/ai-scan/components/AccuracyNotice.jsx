...
export default function AccuracyNotice() {
  return (
    <div className="flex gap-2.5 items-start bg-[#FFF6E0] border border-[#F0E2C0] rounded-xl p-3.5 mb-5">
      <MdWarningAmber className="text-[#F9A825] text-lg flex-shrink-0 mt-0.5" />
