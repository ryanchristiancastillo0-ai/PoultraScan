...
function SuccessModal({ onDone }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      <div className="absolute inset-0 bg-[#1B1D1B]/60 backdrop-blur-sm" />
      ...
      <div className="relative w-full max-w-sm bg-white rounded-2xl shadow-[0_24px_64px_-12px_rgba(11,28,48,0.35)] p-8 flex flex-col items-center text-center">
        <div className="relative w-20 h-20 mb-5">
          <svg className="w-20 h-20" viewBox="0 0 80 80">
            <circle cx="40" cy="40" r="36" fill="none" stroke="#E8F5E9" strokeWidth="4" />
            <circle
              cx="40"
              cy="40"
              r="36"
          ...
          >
            <div className="w-11 h-11 rounded-full bg-gradient-to-br from-[#2E7D32] to-[#43A047] flex items-center justify-center shadow-[0_8px_20px_rgba(0,105,72,0.35)]">
              <FiCheck className="text-white text-2xl" strokeWidth={3} />
            </div>
          </div>
        </div>

        <h2 className="text-xl font-bold text-[#1B1D1B]">Account Created!</h2>
...
export default function Register() {
  ...
  return (
    <div className="bg-[#F8FAF7] min-h-screen flex text-[#1B1D1B] antialiased w-full">
  ...
  <div className="absolute bottom-0 left-0 right-0 p-10 z-10 bg-gradient-to-t from-[#1B1D1B]/70 via-[#1B1D1B]/20 to-transparent">
    ...
    <p className="text-white/80 text-sm max-w-sm">
      AI-powered scans help you catch issues early and keep your flock thriving.
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-16 bg-[#F8FAF7]">
          <div className="w-full max-w-[480px] bg-white rounded-2xl p-6 md:p-10 shadow-[0_4px_12px_rgba(15,23,42,0.04)] border border-[#E8F5E9]">
            ...
            <div className="flex flex-col items-center mb-10">
              ...
              <h1 className="text-2xl md:text-3xl font-semibold tracking-tight text-[#1B1D1B]">Create Your Account</h1>
              <p className="text-base text-[#6B7280] mt-1 text-center">Join PoultraScan AI to start monitoring your flock.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative">
                <div className="relative flex items-center h-[58px] rounded-xl border border-[#D8E3DA] bg-white focus-within:border-[#2E7D32] focus-within:ring-4 focus-within:ring-[#2E7D32]/10 transition-all duration-300 px-5">
                  <FiUser className={`text-xl mr-3 flex-shrink-0 transition-colors duration-200 ${fullNameFocused ? 'text-[#2E7D32]' : 'text-[#6B7280]'}`} />
                  <input
              ...
              <div className="relative">
                <div className="relative flex items-center h-[58px] rounded-xl border border-[#D8E3DA] bg-white focus-within:border-[#2E7D32] focus-within:ring-4 focus-within:ring-[#2E7D32]/10 transition-all duration-300 px-5">
                  <FiLock className={`text-xl mr-3 flex-shrink-0 transition-colors duration-200 ${passwordFocused ? 'text-[#2E7D32]' : 'text-[#6B7280]'}`} />
                  <input
                    className="w-full h-full bg-transparent border-0 p-0 pt-3.5 focus:ring-0 text-[#1B1D1B] text-base outline-none peer"
                    id="password"
                    name="password"
                  ...
                  <button
                    className="text-[#6B7280] hover:text-[#2E7D32] transition-colors focus:outline-none flex-shrink-0 ml-2"
                    type="button"
              ...
              <div className="relative">
                <div className="relative flex items-center h-[58px] rounded-xl border border-[#D8E3DA] bg-white focus-within:border-[#2E7D32] focus-within:ring-4 focus-within:ring-[#2E7D32]/10 transition-all duration-300 px-5">
                  <FiShield className={`text-xl mr-3 flex-shrink-0 transition-colors duration-200 ${confirmPasswordFocused ? 'text-[#2E7D32]' : 'text-[#6B7280]'}`} />
                  <input
                    className="w-full h-full bg-transparent border-0 p-0 pt-3.5 focus:ring-0 text-[#1B1D1B] text-base outline-none peer"
                    id="confirmPassword"
              ...
              <div className="flex items-start py-2">
                <div className="flex items-center h-5">
                  <input
                    className="w-4 h-4 text-[#2E7D32] bg-white border-[#D8E3DA] rounded focus:ring-[#2E7D32] focus:ring-2 cursor-pointer"
                    id="terms"
                    name="terms"
                    required
                    type="checkbox"
                ...
                <div className="ml-3 text-sm">
                  <label className="text-[#6B7280] cursor-pointer" htmlFor="terms">
                    I agree to the <a className="text-[#2E7D32] hover:underline font-bold" href="#">Terms &amp; Conditions</a> and Privacy Policy.
                  </label>
                </div>
              </div>

              <button
                className="w-full h-[56px] bg-[#2E7D32] text-white rounded-lg text-base font-bold hover:bg-[#43A047] active:scale-[0.98] transition-all shadow-[inset_0_1px_0_rgba(255,255,255,0.2)] mt-6 disabled:opacity-50"
                type="submit"
                disabled={loading}
              >
            ...
            <div className="mt-8 text-center">
              <p className="text-base text-[#6B7280]">
                ...
                <a className="text-[#2E7D32] hover:underline font-bold transition-colors" href="/login">Login</a>
              </p>
            </div>
