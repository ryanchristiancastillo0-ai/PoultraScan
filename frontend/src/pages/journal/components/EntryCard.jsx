    ...
    <>
      ...
      <div className="absolute -left-14 sm:-left-[72px] top-3 w-11 sm:w-14 flex flex-col items-center">
        <div className="w-11 sm:w-14 rounded-xl bg-white border border-[#E4ECE7] shadow-[0_2px_8px_rgba(16, 35, 26,0.05)] flex flex-col items-center py-1.5 sm:py-2">
          ...
          <span className="text-[9px] sm:text-[10px] font-bold uppercase tracking-wider text-[#14532D] mt-0.5">
            {month}
          </span>
        </div>
        <span className="w-2 h-2 rounded-full bg-[#14532D] ring-4 ring-[#F7FAF8] mt-2" />
      </div>

      <div className="group bg-white rounded-2xl border border-[#E4ECE7] hover:border-[#14532D]/40 hover:shadow-[0_12px_28px_-10px_rgba(20, 83, 45,0.22)] transition-all duration-200">
        <div className="p-5">
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              <h3 className="font-journal text-base font-semibold text-[#10231A] leading-snug truncate">
                {entry.title}
              </h3>
            ...
            <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0">
              <button
                ...
                className="p-2 text-[#718279] hover:text-[#14532D] hover:bg-[#14532D]/10 rounded-lg transition-colors"
              >
              ...
              <button
                ...
                className="p-2 text-[#718279] hover:text-[#EF4444] hover:bg-[#EF4444]/10 rounded-lg transition-colors"
              >
                <MdDelete className="text-base" />
              </button>
            </div>
          </div>
          <p className="text-sm text-[#4B6357] leading-relaxed mt-3 whitespace-pre-wrap line-clamp-3">
            {entry.content}
          </p>
        </div>
      </div>
