...
export default function HeroVisual() {
  return (
    <Reveal delay={150} className="relative w-full max-w-sm mx-auto lg:mx-0">
      <div className="relative aspect-[4/5] rounded-2xl bg-[#2E7D32] overflow-hidden shadow-[0_24px_60px_rgba(0,111,78,0.35)]">
        ...
        <svg viewBox="0 0 200 240" className="absolute inset-0 w-full h-full opacity-90" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            ...
            fill="#66BB6A"
          />
          <circle cx="128" cy="70" r="5" fill="#2E7D32" />
          <path d="M150 34c10-4 20 2 22 12-10 2-18-2-22-12z" fill="#E2725B" />
          <path d="M96 96l-16 6 12 10 4-16z" fill="#E2725B" />
        </svg>

        {/* Scan sweep */}
        <div className="ps-scan-line absolute left-0 right-0 h-[2px] bg-[#F8FAF7]/80 shadow-[0_0_16px_4px_rgba(248,250,247,0.5)]" />

        <ScanCorners color="#E8F5E9" />
      </div>
