...
export default function Testimonial() {
  const testimonials = [
    {
      ...
      role: "Farm Manager, broiler operation Â· 40,000 birds",
    },
    {
      ...
      name: "Danilo Cruz",
      role: "Farm Supervisor, layer operation Â· 25,000 birds",
    },
    {
    ...
    },
    {
      ...
      role: "Farm Manager, layer operation Â· 30,000 birds",
    },
    {
  ...
  return (
    <section id="results" className="scroll-mt-20 max-w-[1200px] mx-auto px-4 md:px-8 py-20 md:py-28">
      <Reveal className="bg-[#10231A] rounded-2xl px-6 py-14 md:px-16 md:py-16 text-center">
